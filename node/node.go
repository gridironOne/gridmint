...
import (
	...
	"github.com/gridironOne/gridmint/block"
	"github.com/gridironOne/gridmint/config"
	"github.com/gridironOne/gridmint/da"
	daregsitry "github.com/gridironOne/gridmint/da/registry"
	"github.com/gridironOne/gridmint/mempool"
	mempoolv1 "github.com/gridironOne/gridmint/mempool/v1"
	nodemempool "github.com/gridironOne/gridmint/node/mempool"
	"github.com/gridironOne/gridmint/p2p"
	"github.com/gridironOne/gridmint/settlement"
	slregistry "github.com/gridironOne/gridmint/settlement/registry"
	"github.com/gridironOne/gridmint/state/indexer"
	blockidxkv "github.com/gridironOne/gridmint/state/indexer/block/kv"
	"github.com/gridironOne/gridmint/state/txindex"
	"github.com/gridironOne/gridmint/state/txindex/kv"
...
func NewNode(ctx context.Context, conf config.NodeConfig, p2pKey crypto.PrivKey, signingKey crypto.PrivKey, clientCreator proxy.ClientCreator, genesis *tmtypes.GenesisDoc, logger log.Logger) (*Node, error) {
	...
	if conf.RootDir == "" && conf.DBPath == "" { // this is used for testing
		...
		// TODO(omritoptx): Move gridmint to const
		baseKV = store.NewDefaultKVStore(conf.RootDir, conf.DBPath, "gridmint")
	}
