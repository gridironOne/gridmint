...
import (
	...
	"github.com/gridironOne/gridmint/test/loadtime/report"
)

const (
	blockStoreDBName = "gridmint"
)
...
var (
	dir        = flag.String("data-dir", "", "path to the directory containing the gridmint database")
