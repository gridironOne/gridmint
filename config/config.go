...
const (
	flagAggregator        = "gridmint.aggregator"
	flagDALayer           = "gridmint.da_layer"
	flagDAConfig          = "gridmint.da_config"
	flagSettlementLayer   = "gridmint.settlement_layer"
	flagSettlementConfig  = "gridmint.settlement_config"
	flagBlockTime         = "gridmint.block_time"
	flagDABlockTime       = "gridmint.da_block_time"
	flagBatchSyncInterval = "gridmint.batch_sync_interval"
	flagDAStartHeight     = "gridmint.da_start_height"
	flagNamespaceID       = "gridmint.namespace_id"
	flagBlockBatchSize    = "gridmint.block_batch_size"
)

var (
	// DefaultDymintDir is the default directory for gridmint
	DefaultDymintDir = ".gridmint"
)
...
type NodeConfig struct {
	...
	P2P     P2PConfig
	RPC     RPCConfig
	// parameters below are gridmint specific and read from config
