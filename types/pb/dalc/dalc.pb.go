...
type SubmitBatchRequest struct {
	Batch *gridmint.Batch `protobuf:"bytes,1,opt,name=batch,proto3" json:"batch,omitempty"`
}
...
func (m *SubmitBatchRequest) GetBatch() *gridmint.Batch {
	if m != nil {
		return m.Batch
	}
	return nil
...
type RetrieveBatchesResponse struct {
	Result  *DAResponse     `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
	Batches []*gridmint.Batch `protobuf:"bytes,2,rep,name=batches,proto3" json:"batches,omitempty"`
}
...
func (m *RetrieveBatchesResponse) GetBatches() []*gridmint.Batch {
	if m != nil {
		return m.Batches
	}
	return nil
...
func (m *RetrieveBatchesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Batches = append(m.Batches, &gridmint.Batch{})
