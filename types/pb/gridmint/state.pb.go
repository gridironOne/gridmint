...
// source: types/gridmint/state.proto
...
func init() {
	proto.RegisterType((*State)(nil), "gridmint.State")
}

func init() { proto.RegisterFile("types/gridmint/state.proto", fileDescriptor_4b679420add07272) }
