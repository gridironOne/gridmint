...
import (
	...
	cmock "github.com/gridironOne/gridmint/da/celestia/mock"
	...
	"github.com/gridironOne/gridmint/da/registry"
...
func doTestDALC(t *testing.T, dalc da.DataAvailabilityLayerClient) {
	...
	// wait a bit more than mockDaBlockTime, so gridmint blocks can be "included" in mock block
	time.Sleep(mockDaBlockTime + 20*time.Millisecond)
